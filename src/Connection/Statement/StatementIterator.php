...
namespace Subapp\Orm\Connection\Statement;

use Subapp\Orm\Connection\Connection;
use Subapp\Orm\Connection\ConnectionException;
use Subapp\Orm\Connection\StmtInterface;

/**
 * Class StatementIterator
 * @package Subapp\Orm\Connection\Statement
 */
